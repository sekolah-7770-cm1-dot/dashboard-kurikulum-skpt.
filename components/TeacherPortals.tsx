...
const portals = [
  { name: 'DELIMa', desc: 'Google Workspace', icon: '☁️', color: 'bg-blue-50' },
  { name: 'HRMIS 2.0', desc: 'Data Perkhidmatan', icon: '👤', color: 'bg-emerald-50' },
  { name: 'APDM', desc: 'Kehadiran Murid', icon: '📝', color: 'bg-amber-50' },
  { name: 'e-OPERASI', desc: 'Data Guru', icon: '⚙️', color: 'bg-rose-50' },
  { name: 'SPLKPM', desc: 'Latihan Guru', icon: '📚', color: 'bg-indigo-50' },
  { name: 'idMe', desc: 'Pengurusan Identiti', icon: '🔑', color: 'bg-purple-50' },
];
